...
static const char *fonts[]          = { "JetBrainsmono:size=13", "fontawesome:size=14"};
...
static const char *scrot[]    = { "scrot", "%Y-%m-%d_$wx$h.png", "-e", "mv $f ~/Pictures/Screenshots/", NULL };
...
static const char *files[]   = { "xfe", NULL};
//volume controls
